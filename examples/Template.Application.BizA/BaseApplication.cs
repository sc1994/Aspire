...
public abstract class BaseApplication<TDto, TPrimaryKey, TPageParam, TOutput, TCreate, TUpdate>
    ...
    where TUpdate : IPrimaryKey<TPrimaryKey>
{
    ...
    public Task<PageOut<TOutput>> PagingAsync(int index, int size, TPageParam input)
    {
