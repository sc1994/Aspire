...
namespace Aspire
{
        ...
        where TEntity : EntityBase<TPrimaryKey>
    {
        ...
        ///     Initializes a new instance of the
        ///     <see
        ///         cref="AppServiceCrud{        TEntity,         TOrmWhere,         TPrimaryKey,         TQueryFilterDto,         TDto}" />
        ///     class.
        /// </summary>
        /// <param name="repository">仓储实例.</param>
        /// <param name="mapper">mapper实例.</param>
        ...
        where TEntity : EntityBase<TPrimaryKey>
    {
        ...
        ///     Initializes a new instance of the
        ///     <see
        ///         cref="AppServiceCrud{        TEntity,         TOrmWhere,         TPrimaryKey,         TQueryFilterDto,         TOutputDto,         TInputDto}" />
        ///     class.
        /// </summary>
        /// <param name="repository">仓储实例.</param>
        /// <param name="mapper">mapper实例.</param>
