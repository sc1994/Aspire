...
namespace Aspire.Entity
{
    ...
    /// </summary>
    public abstract class EntityFullAuditAccount : EntityFullAudit<Guid>, IEntityBase
    {
    }
    ...
    public abstract class EntityFullAuditAccount<TPrimaryKey> :
        IEntityBase<TPrimaryKey>,
        IAuditSoftDelete,
        IAuditCreate,
        IAuditUpdate,
        IAuditCreateAccount,
        IAuditSoftDeleteAccount,
        IAuditUpdateAccount
    ...
    public class EntityFullAuditAccount<TPrimaryKey, TDatabase> :
